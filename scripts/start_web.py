...
# Windows console often defaults to GBK; enforce UTF-8 to avoid UnicodeEncodeError
def _ensure_utf8_stdio():
    try:
        if os.name == "nt":
            # Wrap stdout/stderr with UTF-8 encoding (replace unsupported chars)
        ...
        # Never fail launcher due to console encoding
        pass
