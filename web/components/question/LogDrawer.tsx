          ...
          <div className="flex items-center gap-3">
            <div
              className={`p-2 rounded-lg ${
                isComplete
                  ? "bg-accent/60 text-primary border border-border ring-1 ring-sky-500/10"
                  : isIdle
          ...
          <div className="px-4 py-4 bg-white dark:bg-slate-800">
            <div className="flex items-center justify-between mb-3">
              ...
              {logs.length > 0 && onClearLogs && (
                <button
                  onClick={onClearLogs}
                  className="flex items-center gap-1 text-xs text-muted-foreground hover:text-primary px-2 py-1 hover:bg-accent rounded transition-colors border border-border"
                  title={t("Clear logs")}
                >
