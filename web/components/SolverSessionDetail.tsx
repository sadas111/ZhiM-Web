                ...
                {session.token_stats && (
                  <>
                    ...
                    {session.token_stats.cost > 0 && (
                      <span className="px-2.5 py-1 text-xs font-medium bg-accent/60 text-primary rounded-full flex items-center gap-1 border border-border ring-1 ring-sky-500/10">
