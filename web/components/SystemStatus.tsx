...
export default function SystemStatus() {
  ...
  const getStatusBg = (status: string) => {
    switch (status) {
      case "online":
      case "configured":
        return "bg-accent/50 border-border ring-1 ring-sky-500/10";
      case "offline":
      case "not_configured":
      case "error":
        return "bg-accent/50 border-border ring-1 ring-sky-500/10";
      ...
      {statusData && (
        <>
          ...
          >
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-2">
                {statusData.llm.status === "configured" && testResults.llm && (
                  <span
                    className={`text-xs ${testResults.llm.success ? "text-primary" : "text-primary"}`}
                  >
            ...
            {testResults.llm && (
              <div
                className={`mt-1.5 text-xs ${testResults.llm.success ? "text-primary" : "text-primary"}`}
              >
          ...
          >
              ...
              <div className="flex items-center gap-2">
                {statusData.embeddings.status === "configured" &&
                  testResults.embeddings && (
                    <span
                      className={`text-xs ${testResults.embeddings.success ? "text-primary" : "text-primary"}`}
                    >
            ...
            {testResults.embeddings && (
              <div
                className={`mt-1.5 text-xs ${testResults.embeddings.success ? "text-primary" : "text-primary"}`}
              >
          ...
          >
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex items-center gap-2">
                {statusData.tts.status === "configured" && testResults.tts && (
                  <span
                    className={`text-xs ${testResults.tts.success ? "text-primary" : "text-primary"}`}
                  >
            ...
            {testResults.tts && (
              <div
                className={`mt-1.5 text-xs ${testResults.tts.success ? "text-primary" : "text-primary"}`}
              >
