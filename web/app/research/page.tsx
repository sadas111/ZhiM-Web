        ...
        <div className="bg-white dark:bg-slate-800 p-4 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col gap-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
              <div
                className={`w-2 h-2 rounded-full ${state.global.stage !== "idle" && state.global.stage !== "completed" ? "bg-sky-500 animate-pulse" : "bg-slate-300 dark:bg-slate-600"}`}
              />
          ...
          <div className="grid grid-cols-1 gap-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-card/80 border border-border rounded-lg text-sm text-foreground outline-none focus:ring-2 focus:ring-primary/25"
              >
                {kbs.length === 0 && (
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-1.5 py-2 px-2 rounded-lg text-xs font-medium transition-all border ${
                        isSelected
                          ? "bg-accent/50 text-primary border-border ring-1 ring-sky-500/10"
            ...
            {/* Optimization Toggle */}
            <div className="flex items-center justify-between bg-secondary px-3 py-2 rounded-lg border border-border">
              <div className="flex items-center gap-2">
                <Sparkles
                  className={`w-4 h-4 ${enableOptimization ? "text-primary" : "text-muted-foreground"}`}
                />
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full relative transition-colors ${enableOptimization ? "bg-sky-500" : "bg-slate-300 dark:bg-slate-600"}`}
              >
                <div
        ...
        <div className="flex-1 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col overflow-hidden">
          ...
          >
            {chatHistory.map((msg) => (
              ...
              >
                <div
                  className={`max-w-[90%] rounded-2xl px-4 py-3 text-sm ${msg.role === "user" ? "bg-accent/60 text-foreground rounded-tr-none border border-border" : "bg-card/70 border border-border text-foreground rounded-tl-none shadow-sm ring-1 ring-sky-500/10"}`}
                >
                  {msg.isOptimizing ? (
                    <div className="flex items-center gap-2">
                  ...
                  state.global.stage === "idle" && (
                    <div className="mt-2 flex gap-2 animate-fade-in">
                      <button
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 bg-primary text-primary-foreground text-xs font-bold rounded-full hover:bg-primary/90 shadow-lg shadow-sky-500/15 ring-1 ring-sky-500/10"
                      >
          ...
          <div className="p-3 bg-white dark:bg-slate-800 border-t border-slate-100 dark:border-slate-700">
            <div className="relative flex items-center gap-2">
              <input
                ...
                className="flex-1 pl-4 pr-10 py-2.5 bg-card/70 border border-border focus:bg-card/80 focus:ring-2 focus:ring-primary/25 rounded-xl text-sm text-foreground placeholder:text-muted-foreground transition-all outline-none disabled:opacity-50"
              />
              <button
                ...
                className="p-2.5 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 disabled:opacity-50 ring-1 ring-sky-500/10"
              >
                {isOptimizing ? (
