      ...
      >
        ...
        <div className="absolute top-4 left-4 z-20 flex gap-2">
          <button
            ...
            className="p-2 bg-card/80 border border-border rounded-lg shadow-sm hover:bg-accent transition-all ring-1 ring-sky-500/10"
            title={
          ...
          {!sidebarCollapsed && (
            ...
            >
              <ArrowRight
                className={`w-4 h-4 text-muted-foreground transition-transform ${sidebarWide ? "rotate-180" : ""}`}
              />
            </button>
          )}
        </div>
        ...
        {sessionState.status === "idle" ? (
          ...
          <div className="flex-1 bg-card/80 rounded-2xl shadow-sm border border-border flex flex-col items-center justify-center text-muted-foreground p-8 ring-1 ring-sky-500/10">
