...
export default function IdeaGenPage() {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case "co_writer":
      default:
        return "bg-accent/70 text-primary border-border ring-1 ring-sky-500/10";
    }
  };
  ...
  return (
    <div className="h-screen flex gap-4 p-4 animate-fade-in">
        ...
        <div className="flex-1 bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 flex flex-col overflow-hidden">
          ...
          <div className="p-3 border-t border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-800/50">
            ...
            <textarea
              ...
              className="w-full px-3 py-2 bg-card/80 border border-border rounded-lg text-sm text-foreground placeholder:text-muted-foreground resize-none focus:ring-2 focus:ring-primary/25 outline-none"
              rows={3}
            />
            {selectedRecords.size === 0 && (
      ...
      <div className="flex-[2_1_67%] min-w-0 flex flex-col bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden">
        {/* Header */}
        <div className="p-4 border-b border-border bg-gradient-to-r from-sky-50/70 to-cyan-50/70 dark:from-sky-950/30 dark:to-cyan-950/20 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-accent/60 rounded-xl border border-border ring-1 ring-sky-500/10">
          ...
          {generatedIdeas.length > 0 && (
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-1.5 text-xs text-primary hover:bg-accent rounded-lg transition-colors border border-border"
              >
                {t("Select All")}
              </button>
              <button
                ...
                className="px-3 py-1.5 text-xs bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 flex items-center gap-1 ring-1 ring-sky-500/10"
              >
        ...
        {(isGenerating || generationStatus) && (
          <div className="px-4 py-2 bg-accent/40 border-b border-border flex items-center justify-between">
            <div className="flex items-center gap-2">
              {isGenerating && (
                <Loader2 className="w-4 h-4 animate-spin text-primary" />
              )}
              ...
              {generatedIdeas.map((idea) => (
                <div
                  ...
                  className={`rounded-2xl border transition-all ${
                    idea.selected
                      ? "bg-accent/50 border-sky-300/60 shadow-md shadow-sky-500/10 ring-1 ring-sky-500/10"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="p-1.5 text-muted-foreground hover:text-primary hover:bg-accent rounded-lg transition-colors border border-border"
